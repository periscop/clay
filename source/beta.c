...
// Returns the beta-vector of the statement, following the given beta-vector or prefix.
// In the latter case, expands the beta-prefix to the first beta-vector inside it.
/**
 ...
 * check if the current statement \b partly corresponds to the beta vector,
 * i.e. if there is at least one scattering relation union part that
 * corresponds to that vector.
